...
with st.sidebar:
    ...
    st.markdown("<br><br><span style='font-size:0.75rem; color:#64748b;'>Sviluppato per laboratori di formazione docenti. Versione 1.1 (Unified)</span>", unsafe_allow_html=True)
